...
{
	ostringstream os;
	os << "Numero de serie          : " << t_Camion.reqNiv() << endl;
	os << "Numero d’immatriculation : " << t_Camion.reqImmatriculation() << endl;
	os << "Date d’enregistrement    : " << t_Camion.reqDateEnregistrement().reqDateFormatee() << endl;
	os << "Nombre d'essieux : "<<t_Camion.req_NbEssieux() << endl;
	os << "Poids : "<< t_Camion.reqPoids() <<" kg" << endl;
	os << "Tarif : "<<t_Camion.tarificationAnnuelle() << "$"<< endl;
